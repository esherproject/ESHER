...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ESHER features */
        {"esher", "listmasternodes", &listmasternodes, true },
        {"esher", "getmasternodecount", &getmasternodecount, true },
        {"esher", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"esher", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"esher", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"esher", "masternodecurrent", &masternodecurrent, true },
        {"esher", "startmasternode", &startmasternode, true },
        {"esher", "createmasternodekey", &createmasternodekey, true },
        {"esher", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"esher", "listmasternodeconf", &listmasternodeconf, true },
        {"esher", "getmasternodestatus", &getmasternodestatus, true },
        {"esher", "getmasternodewinners", &getmasternodewinners, true },
        {"esher", "getmasternodescores", &getmasternodescores, true },
        {"esher", "preparebudget", &preparebudget, true },
        {"esher", "submitbudget", &submitbudget, true },
        {"esher", "mnbudgetvote", &mnbudgetvote, true },
        {"esher", "getbudgetvotes", &getbudgetvotes, true },
        {"esher", "getnextsuperblock", &getnextsuperblock, true },
        {"esher", "getbudgetprojection", &getbudgetprojection, true },
        {"esher", "getbudgetinfo", &getbudgetinfo, true },
        {"esher", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"esher", "mnfinalbudget", &mnfinalbudget, true },
        {"esher", "checkbudgets", &checkbudgets, true },
        {"esher", "mnsync", &mnsync, true },
        {"esher", "spork", &spork, true },
        {"esher", "getcollateral", &getcollateral, true},
...
{
    return "> esher-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20236/\n";
}
