...
/** Utility functions used by the Esher Qt UI.
 */
namespace GUIUtil
{
...
// Render ESHER addresses in monospace font
...
// Parse "esher:" URI into recipient object, return true on successful parsing
