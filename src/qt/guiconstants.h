...
/* Esher GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Esher"
#define QAPP_ORG_DOMAIN "eshercrypto.com"
#define QAPP_APP_NAME_DEFAULT "Esher-Qt"
#define QAPP_APP_NAME_TESTNET "Esher-Qt-testnet"
