...
{
    const char* pszTimestamp = "Make a better world with Blockchain Technology";
    const CScript genesisOutputScript = CScript() << ParseHex("0465e6786302045a0002e3463d3d9998fed47fc73bdeecc321310bdf4a2f78388fcb7cd5883c6f5ebfdee3823b021bea502d1d272db8c83509aeb119251f74e2cc") << OP_CHECKSIG;
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1685065952, // * UNIX timestamp of last checkpoint block
...
/*
        ...
        // /////////////////////////////////////////////////////////////////
         ...
         uint32_t nGenesisTime = 1685065952;
         arith_uint256 test;
         bool fNegative;
         bool fOverflow;
        ...
        // /////////////////////////////////////////////////////////////////
*/
        genesis = CreateGenesisBlock(1685065952, 421012, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000d0a0ad70b3172a463321c4eaadc626438e6a0e688b4d2ecf909a245041f"));
        assert(genesis.hashMerkleRoot == uint256S("0x3fd761093e3ed828c56010e95bb83f3ba859846dd64e41203b885149c3a846d7"));
        ...
        // spork keys
        consensus.strSporkPubKey = "04696b3708d12a2347ab7c66c3b8754fa4cd35ec4928398ad319cea669c5830d37b87150c44f40e776d1ec3692275f9abcad4fba45cd4e07c82468049536d7cab3";
        consensus.strSporkPubKeyOld = "";
        consensus.nTime_EnforceNewSporkKey = 0;
        consensus.nTime_RejectOldSporkKey = 0;

        // dev address
        consensus.devAddress = "EP9bZcPquZ4skuWPCnpPe9AasgKgWeZ2Ey";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.eshercrypto.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.eshercrypto.com"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.eshercrypto.com"));
        vSeeds.push_back(CDNSSeedData("seed4", "seed4.eshercrypto.com"));
	    vSeeds.push_back(CDNSSeedData("seed5", "seed5.eshercrypto.com"));
	    vSeeds.push_back(CDNSSeedData("seed6", "seed6.eshercrypto.com"));
	    vSeeds.push_back(CDNSSeedData("seed7", "seed7.eshercrypto.com"));
	    vSeeds.push_back(CDNSSeedData("seed8", "seed8.eshercrypto.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 33);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 63);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 61);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0xe3)(0xfe)(0x20)(0x77).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0xe3)(0x8b)(0x85)(0xc2).convert_to_container<std::vector<unsigned char> >();
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x97)(0x34)(0x11).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // esher starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet esher addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet esher script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet esher BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet esher BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet esher BIP44 coin type is '1' (All coin's testnet default)
