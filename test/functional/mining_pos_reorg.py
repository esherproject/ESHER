...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected ESHER and zESHER supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zESHERsupply']:
                assert_equal(node['zESHERsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check ESHER and zESHER supply at the beginning
        # ------------------------------------------
        # zESHER supply: 2 coins for each denomination
        ...
        # ESHER supply: block rewards minus burned fees for minting
        ...
        # Verify that ESHER and zESHER supplies were properly updated after the spends and reorgs
        self.log.info("Check ESHER and zESHER supply...")
