...
"""Verify that starting esher with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start esher with -? for help text")
        ...
        self.log.info("Start esher with -version for version information")
