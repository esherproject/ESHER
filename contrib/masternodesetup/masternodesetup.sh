...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='esher.conf'
CONFIGFOLDER='/root/.esher'
COIN_DAEMON='esherd'
COIN_CLI='esher-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/EsherBF/Esher/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
