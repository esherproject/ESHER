...
#define MyAppName "Esher"
#define MyAppPublisher "2022 Esher developers"
#define MyAppURL "https://eshercrypto.com/"
#define MyAppExeName "esher-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/ESHER/bootstrap.zip"
...
[Files]
Source: ".\package\esher-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Esher\Esher-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Esher\Esher-Qt,strDataDir|{userappdata}\Esher\}');
  Result := True;
end;
