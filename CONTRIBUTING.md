Contributing to Esher Core
============================

The Esher Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/EsherBF/Esher/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Esher Core project, and is not to be
confused with overall Esher Network Protocol consensus changes.

Whether a pull request is merged into Esher Core rests with the project merge
...
Patches that change Esher consensus rules are considerably more involved than
...
Where a patchset proposes to change the Esher consensus, it must have been
...
The project leader is the release manager for each Esher Core release.
